...
*** Outline:
	1. 	Analisis
		1.1 Load dataset
		1.2 Fix labels
		1.3 Crear variable atrición
		1.4 Crear variable interacción entre atrición y treatment
		1.5 Exportar a excel
	
	Input: 	Burde and Linden 2013
	Output: tablas
...
*** 1.5 Exportar a excel
	...
	esttab `regs' using "${outputs_3_2}/tablas/tab_3.csv", se replace nogaps
